...
for file in os.listdir(TI_1_DIR): 
    path_wind = TI_1_DIR/(str(file))
    ...
    blade_data.append([mean_blade,std_blade])
    tower_data.append([mean_tower, std_tower])
# end loop 

blade_mean_stdv = np.array(blade_data)
tower_mean_stdv = np.array(tower_data)
print(blade_mean_stdv)
print(tower_mean_stdv)
