...
blade_data_TI_01, tower_data_TI_01 = codecamp.calculate_for_TI(
    TI_01_DIR,  path_ct, turbie_params)

blade_data_TI_005, tower_data_TI_005 = codecamp.calculate_for_TI(
    TI_005_DIR, path_ct, turbie_params)

blade_data_TI_015, tower_data_TI_015 = codecamp.calculate_for_TI(
